...
## Set up plot to contain an array of 2 by 2 graphs

par(mfcol = c(2,2))

## Create line graph of global active power for the entire date range, using
## black lines and labeling y-axis only and leaving the title blank

plot(powerFeb$Date, as.numeric(powerFeb$Global_active_power), type = "l",
     col = "black", main = "", xlab = "",
...
## Top right graph:
## Create line graph of voltage for the entire date range, using
## black lines and labeling y-axis only and leaving the title blank

plot(powerFeb$Date, as.numeric(powerFeb$Voltage), type = "l",
     col = "black", main = "", xlab = "datetime",
     ylab="Voltage")

## Bottom right graph:
## Create line graph of global reactive power for the entire date range, using
## black lines and labeling y-axis only and leaving the title blank

plot(powerFeb$Date, as.numeric(powerFeb$Global_reactive_power), type = "l",
     col = "black", main = "", xlab = "datetime",
